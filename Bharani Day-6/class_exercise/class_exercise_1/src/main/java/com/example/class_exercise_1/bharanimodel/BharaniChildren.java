package com.example.class_exercise_1.bharanimodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class BharaniChildren {
     @Id
     private int babyId;
     ...
     public BharaniChildren() {

     }

     public BharaniChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
