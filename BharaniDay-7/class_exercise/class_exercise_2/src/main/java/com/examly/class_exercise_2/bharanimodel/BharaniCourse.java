...
public class BharaniCourse {
     ...
     public BharaniCourse() {

     }

     public BharaniCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
